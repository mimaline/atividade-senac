function loadDadosExercicios(data_exercicios) {
    ...
    if (data_exercicios == "2022-07-19") {
        return new Array(
            ...
            Array(6, "andreiwelter2", "status_not_initialized", "FALTOU-ANDREI WELTER", data_exercicios, "Exercícios não inicializados ainda, conferir!"),
            ...
            // Array(16, "kauadasilvasilveira14@gmail.com", "status_not_initialized", "KAUÃ DA SILVA", data_exercicios, "Page Not Found!Não existe o github!"),
            ...
            Array(20, "matheusschramm", "status_incomplete", "MATHEUS SCHRAMM", data_exercicios, "Falta alguns exercicios..."),
            ...
            Array(26, "guilhermeschr", "status_incomplete", "GUILHERME SHOROEDER", data_exercicios, "Falta alguns exercicios..."),
        ...
        return new Array(
            ...
            Array(6, "andreiwelter2", "status_not_initialized", "FALTOU-ANDREI WELTER", data_exercicios, "Exercícios não inicializados ainda..."),
            Array(7, "BrunooEduu", "status_ok", "BRUNO EDUARDO", data_exercicios, "ok"),
            //Array(8, "Sn0wye", "status_ok", "GABRIEL TRZIMAJEWSKI", data_exercicios, "Desistente"),
            Array(9, "kkauekk", "status_not_initialized", "KAUÊ CASTANHEIRO GHAHL", data_exercicios, "Exercícios não inicializados ainda"),
            Array(10, "mimaline", "status_ok", "YASMIM ALINE ROEDER", data_exercicios, "ok"),
            Array(11, "laarah", "status_ok", "LARISSA ALVES", data_exercicios, "ok"),
            Array(12, "gleisonschlemper", "status_not_initialized", "GLEISOM SCHLEMPER", data_exercicios, "Exercícios não inicializados ainda"),
            // Array(13, "vivigranza", "status_ok", "-FALTOU-VIVIANE GRANZA", data_exercicios, "Exercícios não inicializados ainda, conferir!"),
            ...
            // Array(16, "kauadasilvasilveira14@gmail.com", "status_ok", "KAUÃ DA SILVA", data_exercicios, "Page Not Found!Não existe o github!"),
            ...
            Array(26, "guilhermeschr", "status_not_initialized", "GUILHERME SHOROEDER", data_exercicios, "ok"),
...
function loadUsers(status) {
    ...
    aListaDataExercicios.forEach(function(data_exercicios, key) {
        ...
        body.innerHTML += `<tr>
                                <td rowspan="5" class="containerTable-lblValue ` + status_exercise + ` center">` + nova_lista + `</td>
        ...
        loadUsersToTable(aListaUsuarios, status);

    });
}

function loadUsersToTable(aListaUsuarios, status_filtro) {
    aListaUsuarios.forEach(function(value, key) {
        ...
        loadDataFromHTML(user, codigo, status, data, observacao, nome, status_filtro);
    });
}

function loadDataFromHTML(user, codigo, status, data_status, observacao, nome, status_filtro) {
    ...
    let adicionaDados = false;

    if (status_filtro == "TODOS") {
        adicionaDados = true;
    } else if (status_filtro == status) {
        adicionaDados = true;
    }
